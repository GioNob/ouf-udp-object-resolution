...
| Production recovery, capacity, SBOM and deployment evidence | PARTIAL | CI restore and regression baseline implemented; infrastructure acceptance, production sizing/SLO, SBOM and deployment evidence remain open |
