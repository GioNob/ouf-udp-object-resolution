...
public class ServingConsumerFixture {
  ...
  @Configuration(proxyBeanMethods=false) public static class Fixture {
    @Bean FilterRegistrationBean<Filter> identity()throws Exception{
      ...
      Set<String> humanCaps=Set.of("urban.object.search","urban.object.read","urban.object.history.read","lineage.object.read","lineage.source.read","udp.replay.plan","udp.replay.execute");
